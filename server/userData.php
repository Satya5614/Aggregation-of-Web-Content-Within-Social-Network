<?php 
  ...
  require_once('lib/faceboobk/facebook.php');
  $config = array(
  ...
  $query = "SELECT * FROM browserSessionInfo WHERE userId=".$_GET[uid]." ORDER BY urlOpeningTime DESC LIMIT 30";
    ...
    <div class="container">
        ...
        <?php
          if($user_id){
            ...
            $user_profile1 = $facebook->api('/'.$_GET[uid],'GET');
              echo "<h3>Internet consumption of <u>" . $user_profile1['name'] ."</u> from <u>" . $user_profile['name'] ."'s Group</u> </h3>";
          }
        ?>
      </div>
